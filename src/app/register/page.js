      ...
      <div className="relative w-full max-w-md animate-fade-in-up">
        ...
        <div className="mb-8 md:mb-10 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-white/5 border border-white/10 rounded-none mb-4 md:mb-6 group hover:border-secondary transition-all duration-500 shadow-[0_0_40px_rgba(200,16,46,0.1)]">
            <span className="material-icons text-4xl md:text-5xl text-secondary group-hover:scale-110 transition-transform">person_add_alt</span>
          </div>
          ...
          <p className="text-white/40 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.3em] md:tracking-[0.4em] mt-3 italic">Register your credentials to the agency</p>
        </div>
          ...
          <div className="border border-white/5 p-6 md:p-8 relative">
            ...
            <form onSubmit={handleRegister} className="space-y-5 md:space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-[9px] md:text-[10px] font-black text-white/50 uppercase tracking-[0.3em]">Proposed Alias</label>
                <input 
                  type="text" 
                  name="username" 
                  required 
              ...
              <div className="space-y-2">
                <label className="text-[9px] md:text-[10px] font-black text-white/50 uppercase tracking-[0.3em]">Encrypted Email</label>
                <input 
                  type="email" 
                  name="email"
                  required 
              ...
              <div className="space-y-2">
                <label className="text-[9px] md:text-[10px] font-black text-white/50 uppercase tracking-[0.3em]">New Security Access Key</label>
                <input 
                  type="password" 
                  name="password"
                  required 
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-center">
              <p className="text-[9px] md:text-[10px] font-bold text-white/30 uppercase tracking-[0.2em]">
                Already Registered? 
                <Link href="/login" className="text-accent hover:text-white ml-2 transition-colors border-b border-accent/30">Existing Access</Link>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-2 opacity-20">
          <span className="material-icons text-xs md:text-sm text-white">shield</span>
          <p className="text-[7px] md:text-[8px] text-white font-black uppercase tracking-[0.4em]">Encrypted Registration</p>
        </div>
      </div>
    </div>
  );
